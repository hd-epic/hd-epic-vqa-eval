...
class Videollama2MetaForCausalLM(ABC):
    ...
    def encode_images_or_videos(self, images):
        ...
        data_batch = []
        for i, (data, modal) in enumerate(images):  # loop batch
            if modal == "image":
        ...
        assert len(data_batch.size()) == 5  # b t c h w
    ...
    def prepare_inputs_labels_for_multimodal(
        ...
        for batch_idx, cur_input_ids in enumerate(input_ids):
            ...
            # breakpoint() # PG: need to investigate whether this takes multivideo inputs. Carefully check below code.
